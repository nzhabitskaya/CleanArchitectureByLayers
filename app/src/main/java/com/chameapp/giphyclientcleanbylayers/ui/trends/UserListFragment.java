...
import com.chameapp.giphyclientcleanbylayers.presenter.TrendsPresenter;
import com.chameapp.giphyclientcleanbylayers.ui.base.BaseFragment;
import com.chameapp.giphyclientcleanbylayers.ui.contract.UserListView;
import com.chameapp.giphyclientcleanbylayers.ui.manager.UsersLayoutManager;
...
public class UserListFragment extends BaseFragment implements UserListView {
    ...
    public interface UserListListener {
        void onUserClicked(final ItemModel userModel);
    }

    @Inject TrendsPresenter userListPresenter;
    ...
    @Override
    public void renderUserList(Collection<ItemModel> userModelCollection) {
        if (userModelCollection != null) {
            this.usersAdapter.setItemsCollection(userModelCollection);
        }
    }

    @Override
    public void viewUser(ItemModel userModel) {
    ...
    private UsersAdapter.OnItemClickListener onItemClickListener =
            new UsersAdapter.OnItemClickListener() {
                ...
                public void onUserItemClicked(ItemModel itemModel) {
                    if (UserListFragment.this.userListPresenter != null && itemModel != null) {
                        UserListFragment.this.userListPresenter.onUserClicked(itemModel);
                    }
                }
            };
}
